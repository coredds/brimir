...
**Why Catch2?**
- [OK] Modern C++20 compatible
- [OK] Header-only option (easy integration)
- [OK] Excellent BDD-style syntax
...
- [OK] All public APIs have unit tests
- [OK] Critical paths have integration tests
- [OK] No untested bug fixes
- [OK] >75% code coverage
...
- [OK] Comprehensive coverage of our code
- [OK] Fast feedback for developers
- [OK] Realistic integration scenarios
- [OK] Pragmatic approach (trust external libs)
