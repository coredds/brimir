...
static const STVGameInfo kGameDB[] = {
    {
        "Radiant Silvergun", 0x1, STV_CONTROL_RSG, STV_EC_CHIP_RSG, STV_ROMTWIDDLE_NONE, false,
    ...
    {
        "Baku Baku Animal", 0x1, STV_CONTROL_3B, STV_EC_CHIP_NONE, STV_ROMTWIDDLE_NONE, false,
    ...
    {
        "Cotton 2", 0x1, STV_CONTROL_3B, STV_EC_CHIP_NONE, STV_ROMTWIDDLE_NONE, false,
    ...
    {
        "Die Hard Arcade", 0x4, STV_CONTROL_3B, STV_EC_CHIP_NONE, STV_ROMTWIDDLE_NONE, false,
    ...
    {
        "Golden Axe: The Duel", 0x1, STV_CONTROL_6B, STV_EC_CHIP_NONE, STV_ROMTWIDDLE_NONE, false,
    ...
    {
        "Guardian Force", 0x1, STV_CONTROL_3B, STV_EC_CHIP_NONE, STV_ROMTWIDDLE_NONE, false,
    ...
    {
        "Puyo Puyo Sun", 0x1, STV_CONTROL_3B, STV_EC_CHIP_NONE, STV_ROMTWIDDLE_NONE, false,
    ...
    {
        "Columns '97", 0x1, STV_CONTROL_3B, STV_EC_CHIP_NONE, STV_ROMTWIDDLE_NONE, false,
