...
/**
@file
@brief Defines `brimir::core::Scheduler`, the event scheduler.
*/
...
public:
    ...
    ///
    /// This function should not be used directly. Use `brimir::Saturn::SaveState` with the full state object instead.
    ///
    ...
    ///
    /// This function should not be used directly. Use `brimir::Saturn::LoadState` with the full state object instead.
    ///
